...
export default class ImageResizerControlledExceptions {
    public static invalidPayload(message, errorsFound: string[]): ResizedException {
        return {
            message,
            status: 400,
            context: errorsFound
    ...
    public static invalidTaskId(): ResizedException {
        return {
            message: 'Task id is invalid, please, check that you are passing a valid number',
            status: 400
        }
    }
    public static invalidDimensions(): ResizedException {
        return {
            message: 'Invalid resizing dimensions, please, check that you are passing a valid number',
            status: 400
        }
    }
